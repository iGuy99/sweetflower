...
import { organizacijaConfig as c } from './config'
import './Organizacija.css'

export default function Organizacija() {
  return (
    <section id="organizacija" className="sf-section sf-organizacija">
